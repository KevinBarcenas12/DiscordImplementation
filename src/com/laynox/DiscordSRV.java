 ...
 * @see #sendJoinMessage(org.bukkit.entity.Player, String)
 * @see #sendLeaveMessage(org.bukkit.entity.Player, String)
 */
...
public class DiscordSRV extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        ConfigManagerUtil.Config.Set(this);
        ConfigManagerUtil.Player.Set(this);
        ...
        initThread.setUncaughtExceptionHandler((t, e) -> {
            ...
            disablePlugin();
            error(e);
            getLogger().severe("DiscordSRV failed to load properly: " + e.getMessage() + ". See " + DebugUtil.run("DiscordSRV") + " for more information. Can't figure it out? Go to https://discordsrv.com/discord for help");
        });
        initThread.start();
    }
        ...
        RestAction.setDefaultFailure(throwable -> {
            if (throwable instanceof HierarchyException) {
                ...
                if (((ErrorResponseException) throwable).getErrorCode() == 50013) {
                    ...
                    debug(Debug.JDA_REST_ACTIONS, throwable.getCause());
                    return;
                }
    ...
    public void processChatMessage(org.bukkit.entity.Player player, String message, String channel, boolean cancelled) {
    ...
    public void processChatMessage(org.bukkit.entity.Player player, Component message, String channel, boolean cancelled) {
    ...
    public void broadcastMessageToMinecraftServer(String channel, String message, User author) {
        ...
        org.bukkit.entity.Player authorPlayer = null;
     ...
     * @see #sendLeaveMessage(org.bukkit.entity.Player, String)
     */
    public void sendJoinMessage(org.bukkit.entity.Player player, String joinMessage) {
     ...
     * @see #sendJoinMessage(org.bukkit.entity.Player, String)
     */
    public void sendLeaveMessage(org.bukkit.entity.Player player, String quitMessage) {
        if (player == null) throw new IllegalArgumentException("player cannot be null");
    ...
    public static String getAvatarUrl(org.bukkit.entity.Player player) {
